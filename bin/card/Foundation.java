...
public class Foundation extends StackOfCards 
{
	...
	/**
	 * Code to make the foundations start only accepting first cards based on the current year
	 * Also lets foundation stacking loop around
	 * Specialized for Anno Domini game
	 * @throws IllegalArgumentException if <code>card</code> does not meet the
	 * 			above conditions.
	 */
